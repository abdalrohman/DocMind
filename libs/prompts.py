...
The question should be valid question for searching on Google, DuckDuckGo, or Bing.
...
RAG_TEMPLATE = """\
You are helpful assistant tasked with answering any question from user.
